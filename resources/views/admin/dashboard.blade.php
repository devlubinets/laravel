...
{{--                                                    <td>angelica@ramos.com</td>--}}
                                        ...
                                        <td>
                                            <a href="{{ route('admin.orders.show', $order->id) }}" class="text-primary"><i class="align-middle mr-2 fas fa-fw fa-eye"></i></a>
                                            <a href="#" class="text-success"><i class="align-middle mr-2 fas fa-fw fa-check"></i></a>

                                            <a href="{{ route('admin.orders.destroy', $order) }}" class="text-danger" onclick="event.preventDefault(); document.getElementById('delete-order{{ $order->id }}').submit();">
