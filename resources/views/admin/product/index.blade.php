                                        ...
                                        <tbody>
                                            @foreach($products as $product)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $product->price }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.products.show', $product) }}" class="show-icons"><i class="align-middle mr-2 fas fa-fw fa-eye"></i></a>
                                                        <a href="{{ route('admin.products.edit', $product) }}" class="edit-success-icons"><i class="align-middle mr-2 fas fa-fw fa-edit"></i></a>

                                                        <a href="{{ route('admin.products.destroy', $product) }}" class="delete-icons" onclick="event.preventDefault(); document.getElementById('delete-product{{ $product->id }}').submit();">
